    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Key)
                .ForeignKey("dbo.Articles", t => t.Article_Key)
                .ForeignKey("dbo.AspNetUsers", t => t.User_Id)
                .Index(t => t.Article_Key)
                .Index(t => t.User_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "Article_Key", "dbo.Articles");
            ...
            DropIndex("dbo.Comments", new[] { "Article_Key" });
